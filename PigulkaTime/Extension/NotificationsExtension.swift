...
//    func scheduleNotifications(forDates dates: [Date], atTimes times: [String], withFrequency frequency: String, notificationIdentifiers: [String]) {
    func scheduleNotifications(forDates dates: [Date], atTimes times: [String], withFrequency frequency: String) {
        ...
        var localNotificationIdentifiers = [String]()
            ...
            for time in times {
                ...
                if let trigger = getNotificationTrigger(forFrequency: frequency, dateComponents: dateComponents) {
                    ...
                    if let notificationDate = notificationDate {
                        ...
                        localNotificationIdentifiers.append(requestIdentifier)
...
//        notificationIdentifiers = localNotificationIdentifiers
        notificationIdentifiers += localNotificationIdentifiers

//        testMassive = localNotificationIdentifiers

        print("Массив индентификатооров local: \(localNotificationIdentifiers)")
        print("Массив индентификатооров global: \(notificationIdentifiers)")
//        print("Массив индентификатооров testMassive: \(testMassive)")
