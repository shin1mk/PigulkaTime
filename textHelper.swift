...
/*
 ...
 Уведомления и их идентификаторы: Когда вы создаете новое уведомление, вы должны сохранять его идентификатор. Далее, при удалении таблетки или каких-то изменениях, вы можете использовать этот идентификатор для удаления соответствующего уведомления.
 Связь уведомлений с таблетками в Core Data: Кажется, что у вас в модели Pigulka есть свойство notificationIdentifiers, но его тип — String?. Однако, по всей видимости, вы хотите хранить здесь массив идентификаторов уведомлений. Вам нужно изменить тип этого свойства на [String], чтобы можно было хранить массив.
 Добавление нового уведомления: В момент добавления нового уведомления к таблетке, сохраните идентификатор уведомления в массив notificationIdentifiers для этой таблетки.
 Удаление таблетки с уведомлением: При удалении таблетки или других изменениях, используйте идентификатор уведомления из массива notificationIdentifiers, чтобы отменить или удалить соответствующее уведомление.
 Сохранение в Core Data: Не забывайте сохранять изменения в Core Data после каждого взаимодействия с вашими объектами таблеток и уведомлений.
 */
